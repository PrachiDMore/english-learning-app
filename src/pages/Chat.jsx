...
const Chat = () => {
  ...
  // Applying Text to speeach
  const [audioUrl, setAudioUrl] = useState("");
  const [loading, setLoading] = useState(false);
  const apiKey = "3796ec780b0ba4b50cde0e178184f2c13a9b08a5";

  const handleConvert = async (text) => {
    setLoading(true);

    const url = `https://api.deepgram.com/v1/speak?model=${gender || gender == 'male' ? 'aura-orion-en' : 'aura-asteria-en'}`;
